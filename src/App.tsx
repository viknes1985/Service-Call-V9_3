                  ...
                  <>
                    {(() => {
                      ...
                      services.forEach((service, index) => {
                        ...
                        if ((index + 1) % 8 === 0 && activeSponsors.length > 0) {
                          const globalSponsorIndex = Math.floor(((findCurrentPage - 1) * 10 + index + 1) / 8) - 1;
                          const sponsor = activeSponsors[globalSponsorIndex % activeSponsors.length];
