                      ...
                      item.type === 'service' ? (
                        ...
                        >
                          ...
                          <div className="absolute top-2 left-2 z-10 flex flex-col gap-1">
                            ...
                            <span className={`text-[8px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider w-fit ${
                              item.data.type === 'Admin' ? 'bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400' :
                              item.data.type === 'Consumer' ? 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400' :
                              'bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400'
                            }`}>
                              {item.data.type || 'Provider'}
                            </span>
                          </div>
