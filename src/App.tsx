                ...
                <div className="grid grid-cols-2 gap-4">
                  {topCategories.length > 0 ? (
                    topCategories.map((cat, idx) => (
                      ...
                      >
                        {/* Large Thumbnail */}
                        <div className={`aspect-square ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} overflow-hidden`}>
                      ...
                      return interleaved.map((item, idx) => (
                        item.type === 'service' ? (
                          <div
                            ...
                            className={`${isDarkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-100'} rounded-2xl shadow-sm border overflow-hidden cursor-pointer hover:shadow-md transition-all relative group`}
                          >
                            <div className={`aspect-square ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} overflow-hidden relative`}>
...
function SponsoredCard({ sponsor, isDarkMode }: { sponsor: Sponsor, isDarkMode: boolean }) {
  ...
  return (
    <div className={`${isDarkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-100'} rounded-2xl shadow-sm border overflow-hidden relative aspect-square group`}>
